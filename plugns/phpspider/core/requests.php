...
class requests
{
    ...
    /**
     * 根据cookie生成的文件设置全局cookie
     * 
     */
    public static function set_cookie_file($cookie_file, $domain = '')
    {
        if (!empty($domain)) 
		{
			self::$domain_cookie_file[$domain][$key] = $value;
		}
		else 
		{
			self::$cookie_file[$key] = $value;
		}
        return true;
    }
